...
def main():
    try:
        resp = requests.get("https://api.github.com/repos/adibozzhanov/PyukuBot/contributors?anon=1")
        ...
        return "The contributors to PyukuBot are " + ", ".join(contributors[:-1]) + " and " + contributors[-1] + "."
